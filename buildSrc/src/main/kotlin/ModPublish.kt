...
class ModPublish(private val project: Project) {
    ...
    val modrinthProjectId = project.optionalStrProperty("publish.project_id.modrinth").orElse("UNSET").toString()
    val curseforgeProjectId = project.optionalStrProperty("publish.project_id.curseforge").orElse("UNSET").toString()
    val hangarSlug = project.optionalStrProperty("publish.project_id.hangar").orElse("UNSET").toString()
    val githubRepository = project.optionalStrProperty("publish.github.repository").orElse("UNSET").toString()
